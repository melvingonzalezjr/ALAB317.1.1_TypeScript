...
var NCycle = /** @class */function () {
  ...
  NCycle.prototype.print = function (numIndex) {
    if (numIndex === void 0) {
      numIndex = 0;
    }
    if (!Array.isArray(this.make) && !Array.isArray(this.model)) {
      console.log("This is a <" + this.make + "><" + this.model + ">.");
    } else if (Array.isArray(this.make) && Array.isArray(this.model) && this.make[numIndex] && this.model[numIndex]) {
      console.log("This has a <" + this.make[numIndex] + "><" + this.model[numIndex] + "> at <" + numIndex + ">.");
    } else {
